...
/*!50013 DEFINER=`tuan`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `products_view` AS select `products`.`id` AS `id`,`products`.`name` AS `name`,`products`.`cost` AS `cost`,`products`.`image` AS `image`,`products`.`date` AS `date` from `products` */;
...
-- Dump completed on 2024-06-16 22:09:40
